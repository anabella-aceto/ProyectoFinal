 ...
 *
 * @Autowired Inyecta la instancia de `DetallePedidoRestController` para realizar las
 *            pruebas.
 * 
 */
@SpringBootTest 
public class DetallePedidoRestControllerTestModificar {
     ...
     *
     * @param detalleDto El detalle de pedido que se va a modificar.
     *                   Debe contener un idDePed existente, idPedido y idSofa.
     * @return ResponseEntity<?> Una respuesta HTTP que indica el resultado de la modificación.
     *                          Si tiene éxito, el código de estado será 200 (OK) y el cuerpo
     *                          contendrá un mensaje indicando que el detalle de pedido se modificó correctamente.
     *                          Si falla, el código de estado será diferente de 200 y el cuerpo
    ...
    public void testModificarDetallePedidoExistente() {
        ...
        assertEquals("Detalle de pedido modificado correctamente", response.getBody()); // Verifica el mensaje de la respuesta
    }

    /**
     * Realiza una prueba para modificar un detalle de pedido que no existe.
     *
     * @param detalleDto El detalle de pedido que se va a intentar modificar.
     *                   Debe contener un idDePed que no existe.
     * @return ResponseEntity<?> Una respuesta HTTP que indica el resultado de la modificación.
     *                          Si tiene éxito, el código de estado será 200 (OK) y el cuerpo
     *                          contendrá un mensaje indicando que el detalle de pedido se modificó correctamente.
     *                          Si falla, el código de estado será diferente de 200 y el cuerpo
    ...
    public void testModificarDetallePedidoNoExistente() {
        ...
        // Verifica que la respuesta sea la esperada
        assertEquals(400, response.getStatusCodeValue()); // Verifica que el código de estado sea 400 (Bad Request)
        assertEquals("No se puede modificar el detalle de pedido", response.getBody()); // Verifica el mensaje de la respuesta
    }
}
